/**
 * @deprecated Compatibility shim mirroring `@policyengine/design-system/tokens/typography`.
 * Use the canonical `typography` export from `@policyengine/ui-kit` for new code.
 *
